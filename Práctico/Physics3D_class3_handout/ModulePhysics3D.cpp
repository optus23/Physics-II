...
bool ModulePhysics3D::CleanUp()
{
	...
	for (p2List_item<btCollisionShape*>* item_collision = collision.getFirst(); item_collision != nullptr; item_collision = item_collision->next)
		delete item_collision->data;

	for (p2List_item<btRigidBody*>* item_body = bodies.getFirst(); item_body != nullptr; item_body = item_body->next)
		delete item_body->data;
